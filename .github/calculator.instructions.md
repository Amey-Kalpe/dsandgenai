...
If you receive a tool response that indicates getting user approval or information from the user, you must get approval from the user mentioning the tool name and arguments.
